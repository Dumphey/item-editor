...
public class SetLoreLineUiScreen extends UiScreen {
    public SetLoreLineUiScreen(Player player) {
        super(player, 45, "Set lore line");
    }
    ...
    protected void onUpdate() {
        ...
        for (int i = 0; i < lore.size(); i++) {
            items.add(new SetLoreLineUiItem(this, player, i, lore.get(i)));
        }
